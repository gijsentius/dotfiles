...
sudo apt update
## general tools
sudo apt -y install suckless-tools curl thunar alsa-utils xbacklight feh lxappearance gtk-chtheme qt4-qtconfig i3status geomview net-tools gucharmap git i3lock gpick vim bc xclip xdotool xsel
